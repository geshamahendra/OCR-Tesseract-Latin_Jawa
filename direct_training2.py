...
def train_tesseract(lang, tif_file, box_file, output_dir, norm_mode=1):
    ...
    try:
        # Step 1: Generate .tr file (training file)
        ...
        # Step 4: Train the shape clustering (creates shapetable, pffmtable)
        ...
        # Step 5: Train mftraining (creates inttemp, normproto)
        ...
        # Step 6: Train cntraining (creates inttemp)
        command_5 = [
            "cntraining", tr_file
        ]
...
train_tesseract(
    lang="eng_jawa",
    tif_file="ocr_tesseract/jTessBoxEditor/Generated_Box/eng.tahoma.exp0.tif",
    box_file="ocr_tesseract/jTessBoxEditor/Generated_Box/eng.tahoma.exp0.box",
    output_dir="ocr_tesseract/output_training",
)
