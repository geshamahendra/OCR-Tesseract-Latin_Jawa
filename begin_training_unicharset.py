...
def run_tesseract_training(tessdata_prefix="../tesseract/tessdata", 
    ...
    :param unicharset_path: Path ke file unicharset
    """
    ...
    if not os.path.exists(unicharset_path):
        raise FileNotFoundError(f"File unicharset '{unicharset_path}' tidak ditemukan.")
...
if __name__ == "__main__":
    try:
        run_tesseract_training(
            ...
            unicharset_path="/Users/geshamahendra/My_Home/ocr_tesseract/create_box_unichar/output.unicharset"
        )
